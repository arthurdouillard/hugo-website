...
The optimal combinations should be taken according to hyperparameters: The accuracy,
...
the hyperparameters in order to maximize our score on the *test data*. This may
...
performance of the different folds:
...
not be able to avoid overfitting.

### Regularization

Another way to way to avoid overfitting is to add *regularization*. It will force
...
There are several regularizations possible. The two most common are **L1**
...
is more learnable by the model. It is dependant on the data's type, and here
lies most of the *black art* of Machine Learning.

Two examples:

For text data, several processing are necessary:
...
by itself the [convolution kernels](https://cs.stanford.edu/people/karpathy/convnetjs/demo/cifar10.html) extracting the interesting features.
...
is to combine different models, kind of like a *wisdom of the crowd*.
